      ...
      <div className="topbar-actions">
        {showActions && (<>
          {onToggleChartDim && chartDim && (
            <button className="icon-btn" aria-label={chartDim==='category' ? 'Switch chart to payment method view' : 'Switch chart to category view'} title={chartDim==='category' ? 'Payment method view' : 'Category view'} onClick={onToggleChartDim}>
